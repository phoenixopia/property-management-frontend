...
import MaintenanceManagmentTenant from '@/app/[locale]/components/tenant-maintenance-managment/MaintenanceManagmentTenant';
  ...
  return (
    <div className=" md:ml-60 text-black dark:text-gray-300 bg-white dark:bg-[#292a2d] min-h-screen ">
        ...
        <div className="flex justify-end items-center py-4 px-12">
          <span className="text-black  dark:text-gray-300 text-sm font-semibold">{t('maintenance-title')}</span>
        </div>
