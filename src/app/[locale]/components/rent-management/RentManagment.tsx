...
import { faPen, faTrash, faEye, faPlus, faFilter } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className='relative overflow-x-auto shadow-md rounded-sm max-h-[400px] overflow-y-auto'>
          <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
            ...
            <tbody>
              {isPending ? (
                <tr>
                 <td colSpan={8} className='px-6 text-black py-4 text-center'>{t('loading')}</td>
                </tr>
              ) : error ? (
                <tr>
                <td colSpan={8} className='px-6 text-black py-4 text-center'>{t('load-error')}</td>
                </tr>
