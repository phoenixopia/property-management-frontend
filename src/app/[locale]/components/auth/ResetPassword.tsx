...
import { resetPasswordSchema } from '../../../../lib/zodTypes'; // Make sure to update your schema
...
export default function ResetPassword({ token }: ResetProps) {
  ...
  // Watch both passwords to compare them
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 bg-cover bg-center" style={{ backgroundImage: "url('/tech-back.jpg')" }}>
      ...
      <div className="relative z-10 bg-white/80 w-full max-w-[25rem] p-8 rounded-2xl shadow-2xl text-white ">
        ...
        <p className="text-center text-sm font-light mb-6 text-gray-700">
          {t('enter-new-password-below-to-change-password')}
        </p>
          ...
          <div className="relative">
            <input
              ...
              {...register('repeatPassword', {
                validate: (value) => value === password || t('passwords-must-match'),
              })}
              className="p-3 pl-10 w-full rounded-lg bg-gray-100 text-black focus:outline-none border border-gray-300"
              required
            />
