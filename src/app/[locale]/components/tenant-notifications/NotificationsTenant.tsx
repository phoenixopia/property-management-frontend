...
import { getAllNotifications, getSingleUserNotifications, readNotifications } from '@/actions/notifications';
...
const NotificationsTenant = () => {
    ...
    const { data: notificationData, isPending, isError, isSuccess } = useQuery({
        ...
        queryFn: () => getSingleUserNotifications(currentPage),
    });
...
export default withAuth(NotificationsTenant, ["tenant"], ["pms.view_rent", "ednant"]);
